...
### 🧩 [Daily LeetCode POTD](https://github.com/Surya-kumar-yadav1)
Repository of daily LeetCode Problem of the Day solutions, tracking consistent DSA practice.

### 🌍 Travel Discovery App
React + Material UI app for discovering restaurants, hotels, and attractions, with live location search and a Google Maps integration.
- **Stack:** React, Material UI, Google Maps API

### 🏥 LifeCare — Hospital Management System
Full-stack system for managing patient records, appointments, and staff operations.
- **Stack:** React, Node.js, Express.js, MySQL

### 🎨 Frosted Glass Calculator
A calculator front end built around a glassmorphism visual style.
- **Stack:** HTML, CSS, JavaScript

### 📝 Notebook-Style To-Do App
A to-do list front end styled to look like a physical notebook.
- **Stack:** HTML, CSS, JavaScript

> All repositories are on my GitHub: **[github.com/Surya-kumar-yadav1](https://github.com/Surya-kumar-yadav1)**
